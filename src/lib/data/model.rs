...
// This allows to Map the Model returned from the query mod into a Domain Clip, proccessed
...
pub struct GetClip {
    // retrieve clip from the database. Make it only accessible from crate::data
    pub(in crate::data) shortcode: String,
}

// used to retrieve the inserted query in the db
